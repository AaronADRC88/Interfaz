...
class FiestraPrincipal:
   ...
   def __init__(self):
    ficheiro="Inter.glade"
    builder=Gtk.Builder()
    builder.add_from_file(ficheiro)

    sinais={"on_txtCadro_activate":self.on_txtCadro_activado,"on_btnAceptar_clicked":self.on_btnAceptar_clicked,"on_fiestraPrincipal_destroy":Gtk.main_quit}
